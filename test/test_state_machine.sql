...
-- Test 15b: ACCEPTED + EXPORT_REQUESTED → ACCEPTED
DO $$
BEGIN
  ASSERT compute_adr_next_state('ACCEPTED', 'EXPORT_REQUESTED') = 'ACCEPTED',
    'ACCEPTED + EXPORT_REQUESTED should stay ACCEPTED';
  RAISE NOTICE 'PASS: Test 15b - ACCEPTED + EXPORT_REQUESTED → ACCEPTED';
END;
$$;

-- Test 15c: ACCEPTED + EXPORT_COMPLETED → ACCEPTED
DO $$
BEGIN
  ASSERT compute_adr_next_state('ACCEPTED', 'EXPORT_COMPLETED') = 'ACCEPTED',
    'ACCEPTED + EXPORT_COMPLETED should stay ACCEPTED';
  RAISE NOTICE 'PASS: Test 15c - ACCEPTED + EXPORT_COMPLETED → ACCEPTED';
END;
$$;
